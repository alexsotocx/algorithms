...
public class SmartWordToyTest {
  ...
  public void test0() {
    ...
    assertEquals(8, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
  ...
  public void test1() {
    ...
    assertEquals(4, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
  ...
  public void test2() {
    ...
    String finish = "mmnn";
    String[] forbid = new String[]{};
    assertEquals(50, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
  ...
  public void test3() {
    ...
    assertEquals(-1, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
  ...
  public void test4() {
    ...
    assertEquals(6, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
  ...
  public void test8() {
    ...
    assertEquals(228, new SmartWordToyInt().minPresses(start, finish, forbid));
  }
